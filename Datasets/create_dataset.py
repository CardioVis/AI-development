...
def process_multiclass_label(label_data, num_classes=3):
...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, dataset, img_size, use_aug=False, data_path='./proceeded_data/', num_classes=3):
    ...
    def __getitem__(self, index):
        ...
        label_data = process_multiclass_label(label_data, num_classes=self.num_classes)
...
def get_dataset_without_full_label(args, img_size=384, train_aug=False, k=6, lb_dataset=Dataset, ulb_dataset=StrongWeakAugment, v_dataset=Dataset):
    ...
    num_classes = getattr(args.data, 'num_classes', 3)
    # Create datasets
    l_dataset = lb_dataset(dataset=l_data, img_size=img_size, use_aug=train_aug, data_path=args.data.train_folder, num_classes=num_classes)
    ...
    val_dataset = v_dataset(dataset=val_data, img_size=img_size, use_aug=False, data_path=args.data.val_folder, num_classes=num_classes)
